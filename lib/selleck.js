...
function configureHandlebars(configFile) {
    if (configFile) {
        configFile = path.resolve(configFile);
        log('Customizing handlebars using: ' + configFile);
        require(path.resolve(configFile))(Handlebars);
    }
}
